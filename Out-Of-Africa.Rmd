...
**As mentioned in the question, due to the out-of-Africa hypothesis, the number of SNPs with greater than zero ALT frequency in the African population is more than the European population.**
...
**As mentioned in the question, the average pairwise diversity within Europe is lesser than both within African population and between European and African population.**
